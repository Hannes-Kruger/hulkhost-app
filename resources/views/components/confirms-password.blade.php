    ...
    <x-dialog-modal wire:model.live="confirmingPassword">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4" x-data="{}"
                ...
                <flux:input type="password" class="mt-1 block w-3/4" placeholder="{{ __('Password') }}"
        ...
        <x-slot name="footer">
            ...
            <flux:button variant="primary" class="ms-3" dusk="confirm-password-button" wire:click="confirmPassword"
